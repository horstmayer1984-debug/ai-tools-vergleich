...
tags: [gemini, google, ki-modell, sprachmodell]
...
Google beschreibt es als "ein smarteres Modell für deine komplexesten Aufgaben". Das ist keine Übertreibung. Das Modell erreicht beim ARC-AGI-2 Benchmark 77,1 Prozent. Das ist mehr als eine Verdoppelung gegenüber Gemini 3 Pro.

**ARC-AGI-2** ist ein Test, bei dem das Modell Aufgaben lösen muss, die es so noch nie gesehen hat. Das misst, wie gut ein Modell wirklich denkt, statt nur auswendig gelernte Muster abzurufen.

---

## Die praktischen Beispiele sind beeindruckend:
...
- **Preise:** Nicht öffentlich genannt
- **Verfügbarkeit:** Noch im Preview
- **Benchmark-Unabhängigkeit:** Wir brauchen Tests von unabhängiger Seite
