...
|---|---|---|
| Erzeugung | Dynamisch aus jeder Anfrage | 70 vorgefertigte Module |
| Themenbreite | Unbegrenzt | Fester Katalog |
| Didaktik | Neutral | Stark, lernoptimiert |
| Eigene Daten | Ja, CSV-Upload | Nein |

ChatGPT gewinnt beim gezielten Mathe-Lernen. Claude gewinnt bei eigenen Daten und Themen ausserhalb des Katalogs.

## Wann Claude besser ist

Eigene Daten analysieren: CSV hochladen, Diagramm beschreiben, fertig. Themen ausserhalb der 70 ChatGPT-Module. Grafiken weiter anpassen — Claudes HTML/SVG-Output ist editierbar.
